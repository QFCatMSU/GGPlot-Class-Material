...
For ***Windows***, [click here to download and install Git](https://git-scm.com/downloads) -- click on ***Download for Windows***. There are a lot of questions Git asks when installing, you can choose the default choice on everything.
...
[Git will not check if you put in wrong or in]{.hl}[valid usernames and emails]{.hl}.
...
![Inviting a user to your GitHub Repository](images/GH_AddUser.png){#fig-invite .fs alt="Inviting a user to your GitHub Repository"}
...
![GitHub after a new Commit was pushed](images/GH_First Push.png){#fig-GitHubPostCommit .fs}

## Application

1.  Send the change to GitHub be executing these lines in the Terminal \<show how these can be done in Git Tab – can show in one image\>:
