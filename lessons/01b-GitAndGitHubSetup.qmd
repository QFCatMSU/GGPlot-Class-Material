...
For ***Windows***, [click here to download and install Git](https://git-scm.com/downloads) -- click on ***Download for Windows***. There are a lot of questions Git asks when installing, you can choose the default option for everything.
...
Most of the Terminal command used in this lesson will only work if you are in the correct RStudio Project. The RStudio Project name (in this case, ***My_Project***) is in the upper-right corner of RStudio.
...
We are now going to create a Git repository in the same folder as your RStudio Project. [Repository]{.hl} is Git and GitHub's name for a Project Folder.
...
1.  Make sure your RStudio Project is open
    ...
    -   Look for your Project name in the upper-right corner (@fig-RStudioTermProj)
...
A [GitHub repository]{.hl} is an online storage location that syncs with the Git repository (Project Folder) on your computer. [Extension: Git and GitHub]
...
3.  Click ***Add people***
    ...
    -   for your instructor, this is: ***belinsky\@msu.edu*** or ***belinskyc***
...
In this section we are going to link your Git repository, which is in the same folder as your RStudio Project, with your GitHub Repository.  The GitHub repository will be the online version of your Git repository. 
...
C\) Create an Issue in your GitHub repository
...
5.  Close the window that pops up
