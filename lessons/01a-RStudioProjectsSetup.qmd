...
# Assets used in this lesson are:
# - images/RSProj_*.*
# - data/RSProj_Setup.csv
# - scripts/RSProj_Setup.R
---
...
![Change settings to view all file extensions on Windows 11](images/RSProj_FileExtensions_Win11.png){#fig-win11 .fs alt="Change settings to view all file extensions on Windows 11"}
...
![Viewing in older versions of Windows](images/RSProj_FileExtensions1.png){#fig-fileExt .fs alt="Viewing in older versions of Windows"}
...
![Change settings to view all file extensions on a Mac](images/RSProj_FileExtensionsMac.png){#fig-fileExtMac .fs alt="Change settings to view all file extensions on a Mac"}
...
![Opening RStudio DMG file](images/RSProj_MacDmgApp.png){#fig-DMGFile .fs alt="Opening RStudio DMG file"}
...
![Unmounting the RStudio device (very important!)](images/RSProj_MacUnmount.png){#fig-unmount .fs alt="Unmounting the RStudio device (very important!)"}
...
![Installing the GGPlot2 Package in RStudio](images/RSProj_InstallPackages.png){#fig-ggplot2 .fs alt="Installing the GGPlot2 Package in RStudio"}
...
![Creating a new RStudio Project](images/RSProj_RStudioNewProj.png){#fig-newRStudioProject .fs alt="Creating a new RStudio Project"}
...
![Creating a directory for the RStudio Project](images/RSProj_RStudioProjectDirectory.png){#fig-projectDir .fs alt="Creating a directory for the RStudio Project"}
...
![Files tab opened to the Project Folder](images/RSProj_RStudioInitFiles.png){#fig-filesTab .fs alt="Files tab opened to the Project Folder"}
...
![Showing hidden files](images/RSProj_HiddenFiles.png){#fig-hiddenFiles .fs alt="Showing hidden files"}
...
![Adding folders using the Files tab in RStudio](images/RSProj_AddFolders.png){#fig-addFolders .fs alt="Adding folders using the Files tab in RStudio"}
...
![The Files tab in RStudio and the File Manager](images/RSProj_ShowFolderInNewWindow.png){#fig-fileExplorers .fs alt="The Files tab in RStudio and the File Manager"}
...
![RStudio opened with an RStudio Project (named My_Project)](images/RSProj_OpenedProjectFolder.png){#fig-fileWindows .fs alt="RStudio opened with an RStudio Project (named My_Project)"}
...
![Opening your first script in RStudio](images/RSProj_FirstScript.png){#fig-openScript .fs alt="Opening your first script in RStudio"}
...
![The Tabs most commonly used in RStudio](images/RSProj_RStudioTabs.png){#fig-tabs .fs alt="The Tabs most commonly used in RStudio"}
...
![Running (Sourcing) the script](images/RSProj_Source.png){#fig-source .fs alt="Running (Sourcing) the script"}
...
![Cleaning out the windows](images/RSProj_CleanWindows.png){#fig-cleanTabs .fs alt="Cleaning out the windows"}
...
![The text color for comments and quotes](images/RSProj_CommentsVsQuotes.png){#fig-colors .fs alt="The text color for comments and quotes"}
...
![Color schemes for RStudio (note: the Editor font might be different in your window -- that is OK)](images/RSProj_ColorScheme.png){#fig-colorSchemes .fs alt="Color schemes for RStudio (note: the Editor font might be different in your window -- that is OK)"}
...
![Console Window changes](images/RSProj_ConsoleWindow-01.png){#fig-consoleChanges .fs alt="Console Window changes"}
...
![Stop RStudio from automatically ending your parenthesis and quotes.](images/RSProj_EndParensQuotes.png){#fig-stopAutoInsert .fs alt="Stop RStudio from automatically ending your parenthesis and quotes."}
...
![Using the RStudio Console to install a package](images/RSProj_UsingConsole.png){#fig-packageInstallation .fs alt="Using the RStudio Console to install a package"}
...
![RStudio looking for packages needed by the script-- click Install and RStudio installs the required package(s)](images/RStudioProj_InstallPackages.png){#fig-RStudioInstall .fs alt="RStudio looking for packages needed by the script-- click Install and RStudio installs the required package(s)"}
...
![The R plot help page in the online documentation.](images/RSProj_HelpWindow.png){#fig-helpTab .fs alt="The R plot help page in the online documentation."}
