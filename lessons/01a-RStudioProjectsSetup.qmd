...
There is a lot of setup in this lesson and the next because it assumes you are starting from scratch. Feel free to skip over sections that you already have on your computer. By the end of the two lessons, I want you to have an RStudio Project on GitHub and share that project with me.

***\<Checklist\>***

### - Special note about images in the lessons for this class

RStudio is a rapidly evolving program, and it would be too much work to maintain all the images so that they reflect the newest version of RStudio and its visual likeness.  Some of the images in this class still reflect the 2019 version of RStudio (v1.1).  And there are minor changes that I have made to the code that I did not believe warrants putting in new images. I have tried to make sure these differences change nothing
functionally.  Inevitably, something will fall through the cracks -- so please, contact the instructor if there is something causing a problem!
...
5.  Zip your Project Folder and email the Zip file to the instructor: belinsky\@msu.edu
...
**To create a Zip file of your Project Folder**

1.   In your File Manager (not in RStudio), [right-click]{.hl} on the Project Folder and in:
    ...
    C.  **Mac**:
        ...
        -    Choose ***Compress "\<Project Folder\>"***

2.  For all operating systems, a zipped file named ***\<Project Folder\>.zip*** with all the Project Folders' contents is created in the same folder
