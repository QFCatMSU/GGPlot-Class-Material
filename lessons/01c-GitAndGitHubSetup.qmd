---
title: "01c: Git and GitHub Setup"
short: "01c"
...
-   Add instructions to replace section 7 for when the instructors provides the GitHub URL
...
[Git will not check if you put in a wrong or invalid username or email]{.hl}.
...
[Note: after the first push, the third line can be reduced to `git push`]{.note}
...
::: {#Issues}
C\) Inform your instructor the application is done by creating an Issue in the Github repostiory:
:::
