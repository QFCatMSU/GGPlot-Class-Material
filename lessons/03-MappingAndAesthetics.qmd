...
One other change to the plot in *fig \##* was to move the legend to the left side of the plot:
...
Save everything in this application in your Class Project's ***scripts*** folder and name the file ***app1-03.r***

 

A\) For the linear model in the last plot, add a mapping of ***color=season***.
...
B\) Create a scatterplot that maps the four columns ***windDir***, ***windSpeed***, ***precip2***, and ***tempDept*** to a scatterplot
...
C\) Create a scatterplot that (somewhat intelligently) makes use of five mappings in one component. 

     [Note: ***shape*** is a common mapping that was not used in this lesson.]{.note}

 

D\) Zip you Project Folder (instructions for Windows and Mac in lesson 01 application)

*E) Email the zipped Project Folder to your instructor*
