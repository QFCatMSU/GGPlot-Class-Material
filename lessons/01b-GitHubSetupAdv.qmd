...
The QFC is moving all student work to GitHub. Using GitHub (and Git) can be a bit tricky for new students, so we’ve created two setup lessons to help you get started:

1.  **Advanced** (this lesson)**:** Student works directly in GitHub giving you a more complete experience.

2.  [**Basic**](01c-GitHubSetupBasic.html)**:** Hides most of GitHub from view, making it simpler to get started.

 

You can choose which lesson to do. If you choose the basic lesson, you will need to request a GitHub URL from {{< var instructor.email >}} before starting.
