...
-   GGPlot image still show facets – switch to rows (because of deprecation)
-   Reduce the amount the students needs to do in this section
-   Combine with Git?
...
[Note: Even if you already have R and RStudio installed, it is a good idea to verify you have the latest version.]{.note}

 

Installing the programs:

1.  **Install (or update) R** (you need R version **4.3** or higher)\
    ...
    -   The installer will tell you If you pick the wrong one -- there is no harm except a bit of wasted time.\
         \
        [Open the file you downloaded and use the default installation options]{.hl}\
         \
        And for those of you using Linux -- the [R for Linux download instructions are here.](https://cran.r-project.org/bin/linux/)  

2.  **Install (or update) RStudio** (you need an RStudio version **2023.12** or later):\
    You can download the [RStudio Installer](https://posit.co/download/rstudio-desktop/) here.\
    Download the appropriate file for your computer under **Installers**, open the file, and use the default installation options.\
     *\
    *[You can also update RStudio by clicking **Help** -\> **Check for Updates**]{.note}
...
In this class we will be using **RStudio** to create, edit, and execute **R** scripts.  In **RStudio**, there is a feature called **RStudio Projects** that makes it much easier to move and share your project.  [You need to keep all of your class work in an RStudio Project.]{.hl}

[ ]{.hl}

Expanding on the terms above:

-   **R**: a programming language that is designed for statistics -- the language is similar to C and JavaScript

-   **RStudio**: the most popular editor for R -- sort of like Word is the most popular editor for Rich-Text Documents

-   **Project Folder:** The folder that contains the files and subfolders for your project

-   **RStudio Project**: An RStudio feature that makes it much easier to move and share your Project Folder by handling the working directory.  I believe that using RStudio Projects should be mandatory for anyone who programs in R and shares their scripts.
...
-   [lesson01-Setup.r](https://raw.githubusercontent.com/QFCatMSU/FW891/main/scripts/lesson01-Setup.R) (right-click, choose ***Save Link as...***): put this file in your ***scripts*** directory

-   [Lansing2016NOAA.csv](/content/DEVELOPMENT/2018/courses/DEV-belinsky-2018-GRaphingwithGGPlot/GGPlot/Lessons/../Data/Lansing2016NOAA.csv?isCourseFile=true): put this file in your ***data*** directory
...
The ***\*.RProj*** files is here and you might also see a folder named ***.RHistory***. These are not files you will need to use right away but you can learn more about them at [Extension: \*.RProj and .Rhistory](#extension-.rproj-and-.rhistory-hidden-files-in-your-project-folder).
...
***lesson01-Setup.R*** takes weather data from the other downloaded file, ***Lansing2016Weather.csv*** and creates boxplots showing how Wind Direction and Wind Speed relate to the Change In Temperature.  The code in ***lesson01-Setup.R*** is something you will progressively learn throughout the course -- for now we are executing the script to test your setup and help you become familiar with the RStudio environment.
...
[Note: the **Help** tab in the lower-right corner is something you might find useful.]{.note}
...
## Your first programming topic: Spacing Code
...
## Stop RStudio from automatically adding matching parenthesis and quotes
...
5.  Zip you Project Folder (instructions for Windows and Mac below)

6.  Email the zipped Project Folder to your instructor

 

**Windows: Zip your Project Folder** (@fig-zip)**:**

1.  In your File Manager (not in RStudio), right-click on the Project Folder

2.  Choose ***Send to***

3.  Choose ***Compressed (zipped) folder***

4.  A zipped file named ***\<Project Folder\>.zip*** is created with all the contents of the Project Folder

![Zipping your Class Folder on Windows -- in this case the zipped file created is named GGPlotRoot.zip](images/GGP-01-01-ZipFolder.PNG){#fig-zip .fs}

 

**Mac: Zip your Project Folder:**

1.  In your File Manager (not in RStudio), right-click on the Project Folder

2.  Choose ***Compress "\<Project Folder\>"***

3.  A zipped file named ***\<Project Folder\>.zip*** is created with all the contents of the Project Folder
...
## Extension: Working directories in R and RStudio
...
An RStudio Project sets the working directory as the root folder of the project.  So, for ***weather.r*** to find ***weather.csv*** inside an RStudio Project, it just needs to know where ***weather.csv*** is located relative to the root folder.  Most likely this will be something like: ***Data\\weather.csv***. This makes it far easier to share your project because the path to ***weather.csv*** will be the same on any computer.
