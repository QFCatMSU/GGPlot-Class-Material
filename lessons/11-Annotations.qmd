...
Create a script file in your Project's ***scripts*** folder called ***app11.r*** and, using the data from **Lansing2016NOAA.csv:**
...
3\) Using ***annotate***, create a plot of \$\$y = x{"version":"1.1","math":"\<math xmlns="http://www.w3.org/1998/Math/MathML"\>\<mi\>y\</mi\>\<mo\> \</mo\>\<mo\>=\</mo\>\<mo\> \</mo\>\<msqrt\>\<mi\>x\</mi\>\</msqrt\>\</math\>"}:\$\$
