...
This lesson is only for students who are given a GitHub repository URL from the instructor. For those students this lesson replaces ***01b: Git and GitHub Setup***. If you have already done the ***01b: Git and GitHub Setup*** lesson, you do not need to do this lesson.
...
Before you can use Git, you need to configure Git on your computer with your GitHub username and email (i.e., the email you use to sign up for your GitHub account).
...
1.  Make sure your RStudio Project is open (@fig-RStudioTermProj)
...
After you add Git to an RStudio Project folder, a ***Git*** tab will appear in the upper-right window. This tab is RStudio's built-in Git interface and it can handle many commonly performed Git functions, including most of the things needed for class. The ***Git*** tab is often helpful, but not necessary, to use.
...
-   note: when you Push, the instructor should get an email, so this part is just to double-check
