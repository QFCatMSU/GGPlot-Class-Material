...
-   equations
-   CSS does not indicate if a figure has an ID that starts with "fig-"
...
-   periods in header titles will mess up highlighting (because the period in JS means something)
...
-   image resizing does not work when you set height or width in Quarto editor
...
![](images/belinsky2.JPG){width="800"}

### Technical Support

You can contact me, Charlie, regarding technical issues. 

MSU also offers [**24 hour technical support**](https://tech.msu.edu/support/help/) for students. This support includes hardware, software, and D2L.
...
You need an MSU ID or an MSU Guest ID to access the class. You can [get an MSU Guest ID here](https://community.idm.msu.edu/).  Your MSU Guest ID is the same as the email you used to get it.
...
Clicking on the clipboard in the upper-right corner of the codeblock will copy the code to the clipboard. You can then paste the code into RStudio (or any other text editor)
...
[Clicking on clipboard in upper-right corner selects all the text and copies it to the clipboard]{#fig-codeBlock .fig}
