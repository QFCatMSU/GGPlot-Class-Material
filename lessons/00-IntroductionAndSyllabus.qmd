...
1.  **Setup**:
    ...
    a.  **RStudio Project:** Set up software and the programming environment for the class, go over the programming environment

    b.  **Git and GitHub:** Set up the Environment for sharing your project with the instructor. There are two versions of this lesson, the second is simpler but less robust
