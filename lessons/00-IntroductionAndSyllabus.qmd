...
![](images/belinsky2.JPG){width="700"}
...
![Testing the audio and video in Zoom (click on picture to resize).](images/R-00-Zoom.PNG){#fig-zoomImg}
...
[Double clicking on the codeblock selects all the text and copies it to the clipboard]{#fig-codeBlock}
