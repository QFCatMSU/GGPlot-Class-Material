...
Properties like ***color, size, and shape*** can be used to map data to a plot component (arguments for ***aes()*** as in *fig \##*) or they can be used to directly set the property of a plot component (subcomponents of the plot as in *fig \##*).  *They can not be used for both*.  If you use these properties as both a mapping and a subcomponent, the subcomponent will override the mapping.
...
The ***theme()*** page can be a bit tricky to read.  Many of the subcomponents are grouped together (*fig \##*) and the groupings can be hard to see.
...
Create a script file in your Project's ***script*** named ***app04.r*** and, using the data from **Lansing2016NOAA.csv***,* replicate (as best you can) this canvas:
