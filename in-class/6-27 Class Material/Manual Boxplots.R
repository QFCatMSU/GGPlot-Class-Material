{
  ...
  ##### To manually get data for boxplots
  # 1) get all relHum values for days where there is no precipitation
  # 2) get the mean, median, and standard deviation for the data
  ...
  plot2 = ggplot() +  
    ...
    # Need to use scale_x_continuous instead of scale_x_discrete
