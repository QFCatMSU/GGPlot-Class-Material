{
  ...
  # grid.arrange() will print to the Plots window but you need to 
  #   save the information to save to pdf or png
  multiPanel = grid.arrange(hist1, hist2, hist3, hist4, hist5,
  ...
  ggsave(file="output/app10-multipanel.png", 
         plot=multiPanel,
         width=10, 
         height=7, 
         units="in");  # unit options: cm, in, mm
  
  # save one of the plots above to a pdf file 
  ggsave(file="output/app10-hist4.pdf", 
         plot=hist4,
         width=25, 
         height=12, 
         units="cm");  # unit options: cm, in, mm
}