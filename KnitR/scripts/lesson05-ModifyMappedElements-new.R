{
  ...
  # Running the script directly in RStudio -- this means the 
  ...
  # Running the script from an RMD file -- this means the
  # Working Directory is the same as the folder the RMD file is in
  if (class(didItWork) == "try-error")
  {
    weatherData = read.csv(file="../data/Lansing2016NOAA.csv");
  }
