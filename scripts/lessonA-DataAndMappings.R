{
  ...
  #     mapping
  #     geoms
  #      geoms link: https://ggplot2.tidyverse.org/reference/#geoms
  #     annotate
  
  #### 2 bugs in GGPlot that cause issues with mapping:
  #    1) faceting data must come from a previously declared data frame
...
# plot(plotB4); # Error: only 'grobs' allowed in "gList" (makes sense, right?!?)
  ...
  ## Definitions Grammar of Graphics book
  #   visual: any part of the plot
  #   graphics: portion of plot that visually represents data (p.36)
  ...
  #      - faster than geoms
  #      - unfortunately, annotate in GGPlot is not consistent
  #      - package are especially bad (geom_circle, geom_ellipse)
